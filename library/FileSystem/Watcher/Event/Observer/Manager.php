...
namespace FileSystem\Watcher\Event\Observer;
...
class Manager
{
    ...
    public function __construct(\FileSystem\Watcher\Event\Reader $reader)
    {
        $this->subjects = new \SplObjectStorage();
        $this->setEvents($reader);
    }

    public function setEvents(\FileSystem\Watcher\Event\Reader $events)
    {
        $this->events = $events;
    }

    /**
     * @param \FileSystem\Watcher\Event\Observer\Subject\SubjectInterface $subject
     * @param \Enum\EventType $type
     * @return \FileSystem\Watcher\Event\Observer\Manager
     */
